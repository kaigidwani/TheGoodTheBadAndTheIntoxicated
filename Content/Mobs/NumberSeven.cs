    ...
    internal class NumberSeven : ModNPC
    {
        ...
        public override void SetBestiary(BestiaryDatabase database, BestiaryEntry bestiaryEntry)
        {
            bestiaryEntry.AddTags(BestiaryDatabaseNPCsPopulator.CommonTags.SpawnConditions.Biomes.Desert,
                new FlavorTextBestiaryInfoElement("The quickest of the Billiard Boys. His draw has only been rivaled by one man. He'll make sure that mistake will never happen again."));
        }
        ...
        {
            npcLoot.Add(ItemDropRule.Common(ModContent.ItemType<SixShooter>(), chanceDenominator: 8));
